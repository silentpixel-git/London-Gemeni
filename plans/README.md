...
|---|------|----------|------------|--------|
| 1 | [001-high-feel-breaking.md](001-high-feel-breaking.md) | H1 dead `animate-in` classes, H2 command spring, H3 reduced-motion, H4 global `*` transition, H5 typewriter skip + early-onComplete | — | TODO |
| 2 | [002-medium-noticeably-off.md](002-medium-noticeably-off.md) | M5 motion tokens, M1 dropdown origin, M2 modal entrances, M3 sidebar slide, M4 streaming `transition-all`, M6 bounce→pulse, M7 dropdown easing, M8 toast exit | Plan 001 (plugin) | TODO |
