...
export const GameOverScreen: React.FC = () => (
  <div className="flex flex-col items-center justify-center py-16 border-t border-lb-accent/20 mt-12 space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
    ...
    <button
      ...
      className="group flex items-center gap-3 px-10 py-4 bg-lb-primary text-lb-bg rounded-full font-sans text-xs tracking-[0.2em] uppercase pressable shadow-xl hover:-translate-y-1 hover:shadow-[0_0_0_3px_rgb(var(--lb-accent)/0.4)]"
    >
