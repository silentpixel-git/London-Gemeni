...
export const FACTS: StoryFact[] = [
  ...
  { id: 'holmes_boots_bermondsey', statement: 'Oak bark, lime, and south-bank river silt, caked into a pair of boots in a dry August. Four streets in London could put all three on one sole, and every one of them is a tanyard in Bermondsey', knownBy: ['holmes'], visibleFromAct: 0, topics: ['the boots', 'the mud', 'bermondsey'] },
  ...
  { id: 'holmes_honest_object', statement: 'Everything she took, she chose. The workbox is the one thing she did not think about, and is therefore the only honest object in the room', knownBy: ['holmes'], visibleFromAct: 0, topics: ['the workbox', 'what she left behind'] },
