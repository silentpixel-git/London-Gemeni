...
export const LOCATIONS: Record<string, LocationDefinition> = {
  ...
  bucks_row: {
    ...
    reconstitutionNote: "Watson visits in late November 1888 — three months after Mary Ann Nichols was murdered here on August 31st. The street has returned to its ordinary rhythm. There is no crime scene, no police presence. Watson works from Abberline's notes and Bond's written post-mortem report. Holmes reasons from the physical geography.",
  ...
  working_mens_club: {
    ...
    description: 'The room is filled with the scent of cheap tobacco and the energy of debate. Posters and newspapers line the walls. Diemschutz stands near the bar, a man who discovered a body eight weeks ago and has not quite recovered his equilibrium.',
