...
description: Reference guide for Watson's narrative voice in London Bleeds. Claude should load this automatically when editing AIService.ts, modifying narration prompts, or writing any in-game prose. Not user-invocable.
