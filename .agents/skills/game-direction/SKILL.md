---
name: game-direction
description: Design principles and player experience guidelines for London Bleeds. Codex loads this automatically when making UI decisions, designing new mechanics, writing player-facing text, or evaluating feature proposals.
